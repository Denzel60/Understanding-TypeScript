...
var ProjectList = function () {
    var _a;
    var _classSuper = base_component_js_1.Component;
    ...
    return _a = /** @class */ (function (_super) {
        ...
        (function () {
            ...
            _dragOverHandler_decorators = [autobind_js_1.autobind];
            _dropHandler_decorators = [autobind_js_1.autobind];
            _dragLeaveHandler_decorators = [autobind_js_1.autobind];
